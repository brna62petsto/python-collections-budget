...
class Expenses():
    ...
    def categorize_set_comprehension(self):
        necessary_expenses = {x for x in self.list(x.category == 'Phone' or x.category == 'Auto and Gas' or x.category == 'Classes' or x.category == 'Utilities' or x.category == 'Mortgage')}
        food_expenses = {x for x in self.list(x.category == 'Groceries' or x.category == 'Eating Out')}
